...
class Memory:
    ...
    def __init__(self, num_nodes: int, dim_edge: int, dim_memory: int,
                 ...
                 shared_memory: bool = False, mailbox_size: int = 10,
                 kvstore_client: Optional[KVStoreClient] = None,
                 update_mail_pos=None, next_mail_pos=None):
        """
        Args:
        ...
        self.update_mail_pos = update_mail_pos
    ...
    def resize(self, num_nodes):
        ...
        self.next_mail_pos.resize_(num_nodes,)
        ...
        self.next_mail_pos[self.num_nodes:].fill_(0)
    ...
    def backup(self) -> Dict:
        ...
        return {
            ...
            'next_mail_pos': self.next_mail_pos.clone()
        }
    ...
    def update_mem_mail(self, last_updated_nid: torch.Tensor,
                        ...
                        last_updated_ts: torch.Tensor, block,
